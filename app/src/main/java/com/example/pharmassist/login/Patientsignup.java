    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movelogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Patientsignup.this, Loginpage.class);
                startActivity(i);
            }
        });
        ...
        myApi = retrofit.create(MyApi22.class);
                ...
                if (email.isEmpty()) {
                    ...
                    modelCall.enqueue(new Callback<Model>() {
                        ...
                        public void onResponse(Call<Model> call, Response<Model> response) {
                            if (response.isSuccessful() && response.body() != null) {
                                ...
                                if (model.getSuccess().equals("true")) {
                                    Toast.makeText(Patientsignup.this, "Sign up successful! You can now login.", Toast.LENGTH_SHORT).show();
                                    Intent move = new Intent(Patientsignup.this, Loginpage.class);
                                    startActivity(move);
                                } else {
                                    Toast.makeText(Patientsignup.this, model.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            } else {
                        ...
                        public void onFailure(Call<Model> call, Throwable t) {
                            Toast.makeText(Patientsignup.this, "Failed to sign up. Please try again.", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
